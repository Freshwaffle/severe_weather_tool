...
# =========================
# Analysis (fully safe with safe_float)
# =========================
def analyze(df):
    ...
    # Safe extraction for masked or complex values
    def safe_float(val):
...
# (storm_mode, CRI, plot_skewt remain the same as before)

# =========================
# Streamlit App (tab2 fixed)
# =========================
